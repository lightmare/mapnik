...
:: since any CL.EXE with /MP option is able to use all available processors (provided there
:: are enough sources in the project), using multiple MSBUILD workers only makes sense when
:: we have more processors than sources per project
...
IF DEFINED APPVEYOR SET _CL_=/MP
msbuild ^
